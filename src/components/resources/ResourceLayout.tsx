    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0f]">
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur dark:border-white/10 dark:bg-[#0a0a0f]/95">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          <Link to="/resources" className="flex items-center gap-2 font-bold text-gray-900 dark:text-white">
            <BookOpen className="h-5 w-5 text-aicc-purple" />
            AI Resources
          </Link>
          <a href="https://github.com/JithunMethusahan/ioai-community-contest" target="_blank" rel="noreferrer"
